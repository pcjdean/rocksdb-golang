...
// Default: nullptr
DEFINE_C_WRAP_SETTER_WRAP(DBOptions, info_log, PLogger)
...
// Default: true
DEFINE_C_WRAP_SETTER(DBOptions, paranoid_checks, bool)
...
// Default: 5000
DEFINE_C_WRAP_SETTER(DBOptions, max_open_files, int)
...
// Default: true
DEFINE_C_WRAP_SETTER(ReadOptions, verify_checksums, bool)
// Should the "data block"/"index block"/"filter block" read for this
// iteration be cached in memory?
// Callers may wish to set this field to false for bulk scans.
// Default: true
DEFINE_C_WRAP_SETTER(ReadOptions, fill_cache, bool)
